        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              A premier university coding club dedicated to fostering innovation, collaboration, and excellence in
              software development. Join us on a journey of continuous learning and growth.
            </p>
          ...
          {/* Right Column */}
          <div
            className="relative h-96 md:h-full min-h-96 rounded-2xl p-8 flex items-center justify-center animate-blur-in"
            style={{
